...
custom.skills.extend(['Choose', 'Choose', 'Choose'])
...
cultist.skills.extend(['Melee Weapons', 'Speech', 'Sneak'])
cultist.trait = 'The Sight Beyond'

human_cultist_gear = [
    'Human',
    'setattr(self, "caps", 50)',
    (Armor('Cloth (upgraded'), 1, ['UPGRADES', 'Lead-lined (Rank 1)']),  # format is (class_instance, qty, [properties_if_any])
